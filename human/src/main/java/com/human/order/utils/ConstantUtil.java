...
public class ConstantUtil {
	...
	//初始化
	public static String APP_ID = "wxff8eebcb45922698";//微信开发平台应用id   
	public static String APP_SECRET = "e06b1391bb726d99d6b0b66156391dff";//应用对应的凭证   
	//应用对应的密钥
	...
	public static String PARTNER = "1279536801";//微信支付商户号          
	public static String PARTNER_KEY = "63919EC0B26F2D052152FE0E2C6B58AD";//商户号对应的密钥  
