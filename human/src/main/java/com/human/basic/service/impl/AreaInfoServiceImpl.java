...
import com.human.utils.ChineseCharToEn;
...
public class AreaInfoServiceImpl implements AreaInfoService {
    ...
    @Override
    public List<AreaInfo> getProByUser(String useName) {
        return areaInfoDao.getProByUser(useName);
    }

    @Override
    public List<AreaInfo> getCityByUser(Map<String, Object> param) {
        return   areaInfoDao.getCityByUser(param);
    }
    ...
    @Override
    public List<AreaInfo> getAreaInfoByHrCompanyId(Map<Object, Object> map) {
        return areaInfoDao.getAreaInfoByHrCompanyId(map);
    }
