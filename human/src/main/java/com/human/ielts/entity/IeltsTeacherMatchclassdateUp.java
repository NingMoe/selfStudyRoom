...
public class IeltsTeacherMatchclassdateUp {
    ...
    @ExportTitleAnnotation()
    @ExcelAnnotation(exportName="赛课时间")
    private String matchclass_date;
    ...
    public String getMatchclass_date() {
        return matchclass_date;
    }

    public void setMatchclass_date(String matchclass_date) {
        this.matchclass_date = matchclass_date;
    }
}
