...
<head>
	...
	<script type="text/javascript" src="<%=basePath %>/static/ielts/teacher/integralchange.js"></script>
</head>
			...
			<div class="layui-form" style="width: 450px;">
				<div class="layui-form-item">
					...
					<div class="layui-inline" style="margin: 0 auto; width: 32%;">
						...
						<button class="layui-btn layui-btn-mini" style="margin-top: 9px;" id="btn_tkt_source"><i class='fa fa-check'></i>&nbsp;编辑</button >
					</div>
					<div class="layui-inline" style="margin: 0 auto; width: 32%;">
			...
			<div class="layui-form" style="width: 450px;">
				<div class="layui-form-item">
					...
					<div class="layui-inline" style="margin: 0 auto; width: 32%;">
						...
						<button class="layui-btn layui-btn-mini" style="margin-top: 9px;" onclick=""> <i class='fa fa-check'></i>&nbsp;编辑</button >
					</div>
					<div class="layui-inline" style="margin: 0 auto; width: 32%;">
		...
		<div class="alertFrom" style="width: 400px; width : 450px; float: left; text-align: center;">
			...
			<div class="layui-form" style="width: 450px;">
				...
				<div class="layui-form-item">
					...
					<div class="layui-inline" style="margin: 0 auto; width: 32%; text-align: center;">
						<button class="layui-btn layui-btn-mini" style="margin-top: 9px;" onclick=""> <i class="fa fa-check"></i>&nbsp;编辑</button>
					</div>
					<div class="layui-inline" style="margin: 0 auto; width: 32%;">
					</div>
