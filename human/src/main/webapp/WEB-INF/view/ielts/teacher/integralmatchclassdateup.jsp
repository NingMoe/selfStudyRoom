...
<head>
	...
	<script type="text/javascript" src="<%=basePath %>/static/ielts/teacher/integralmatchclassdateup.js"></script>
</head>
		...
		<div class="layui-form">
			...
			<div class="layui-form-item">
				<div class="layui-input-block" >
					<button class="layui-btn" lay-submit="" id="teacher_matchclass_tj">提交</button>
				</div>
			</div>
		</div>
	</div>
