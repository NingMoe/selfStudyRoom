...
<head>
	...
	<script type="text/javascript" src="<%=basePath %>/static/ielts/student/enrollinfo.js"></script>
<body >
<input id="student_id" type="hidden" value="">
	...
	<fieldset class="layui-elem-field" style="padding: 15px;" id="serachFrom">
		...
		<div class="y-role">
            ...
            <div id="toolbar">
            	<button onClick="addenrollinfo()" type="button" class="layui-btn">
				<li class="fa fa-plus-square"></li>
				&nbsp;新增考试信息
				</button>
				<button onClick="deletesenrollinfo()" type="button" class="layui-btn">
				<li class="fa fa-plus-square"></li>
				&nbsp;批量删除
				</button>
            </div>
