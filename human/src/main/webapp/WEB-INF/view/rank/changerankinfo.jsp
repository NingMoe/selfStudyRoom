...
<head>
	...
	<body style="padding:10px;">
		<div class="alertFrom">
			<div class="layui-form">
				...
				<div class="layui-form-item layui-form-text">
				    ...
				    <div class="layui-input-inline">
				      <input name="b_color_code" id="b_color_code" class="color"  value="000000" style="width: 160px;" type="text" placeholder="请输入页面颜色css码" class="layui-input">
				    </div>
   			    </div>
		...
		<!-- layui.use -->
	    <script type="text/javascript" src="<%=basePath %>/static/rank/changerankinfo.js"></script>
	</body>
</html>