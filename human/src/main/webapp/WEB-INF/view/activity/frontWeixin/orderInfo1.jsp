...
<div class="mycard">
	...
	<p class="adr">杭州路3333号和盛公馆27栋3楼</p>
...
① 适用范围：在滨湖保利校区前台报名，且所报课程为泡泡少儿部优能初中部、优能一对一部设置在滨湖保利校区的寒春班级；</br>
② 每个班级仅限使用一张抵用劵；</br>
...
<div class="xiaoqu">
	<div class="kecheng">
		...
		<p class="kecheng_p">新东方合肥学校成立于2006年6月，是新东方教育科技集团旗下第28家直营分校。目前在合肥市拥有26家学习中心，开设有泡泡少儿（语文/数学/英语）、优能中学（全科）出国考试（托福/雅思/GRE/SAT/ACT）、大学考试（考研/四六级/口语）等培训课程及国际冬夏令营等业务。截止2016年5月，学校已累计培训学员55万人次。</p>
	</div>
</div>
</body>
