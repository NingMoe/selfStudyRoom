...
<div class="form-group" style="text-align: center; "><button  lay-submit="" lay-filter="sub1"  type="button" class="layui-btn layui-btn-primary">继续反馈</button><%--&nbsp;&nbsp;<button type="button" class="layui-btn" onclick="closeFeedback('${fb.id}');">&nbsp;关闭问题</button></div>
 --%>		</form></div>
	...
	<c:if test="${fb.state==2}">
		<div class="form-group" style="text-align: center; margin-top: 20px;"><button onclick="javascript:window.history.back(-1);" type="button" class="layui-btn layui-btn-primary "><li class="fa fa-reply"></li>&nbsp;返&nbsp;回&nbsp;</button></div>
	</c:if>
	</div>
...
function showImgs(obj,k){
	...
	function jxfeedback(){
		...
		for(var j=0;j<imgs.length;j++){
	      ...
	      xhr.open('post', jsBasePath+'/wechat/binding/feedback/jxfeedback.html');
