			   ...
			   <input type="hidden" name="id" value="${info.id }">
				...
				<div class="layui-form-item">
				   <label class="layui-form-label" style="width: 100px;">开始时间:</label>
					<div class="layui-input-inline">
						<input  id="startTime" name="startTime" autocomplete="off"  placeholder="请输入开始时间" lay-verify="required" class="layui-input" value="${startTime}">
					</div>
					<div class="layui-form-mid layui-word-aux"><font color="red">*</font></div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline" >
						<input  id="endTime" name="endTime" autocomplete="off"  placeholder="请输入结束时间" lay-verify="required" class="layui-input" value="${endTime}">
					</div>
					<div class="layui-form-mid layui-word-aux"><font color="red">*</font></div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
						<input type="checkbox" name="isSend" value="1" lay-filter="isSend" title="是否发送短信" <c:if test="${info.isSend eq '1' }">checked="checked"</c:if>>											
					</div>							
				</div>
...
<script type="text/javascript" src="<%=basePath %>/static/sign/edit.js"></script>
</html>