...
<form class="layui-form">
	...
	<div class="layui-form-item layui-form-text" style="margin-top:20px;">
		...
		<div class="layui-input-inline" style="width:235px;">
			...
			name="interviewTime" placeholder="面试时间" value="<fmt:formatDate value='${record.interviewTime }' pattern='yyyy-MM-dd hh:mm:ss'/>" 
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline" style="width:235px;">
		     <input type="text" id="interviewLocation" name="interviewLocation"
		     value="${record.interviewLocation }"
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline" style="width:235px;">
			<input type="text" id="interviewer" name="interviewer" lay-verify="required" value="${record.interviewer }" class="layui-input">
		</div>
	</div>
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-inline" style="width:235px;">
			<textarea id="interviewRemark" name="interviewRemark" class="layui-textarea">${record.interviewRemark }</textarea>
		</div>
	</div>
	...
	<!-- <div class="layui-form-item">
		...
		<div class="layui-input-inline">
		     ...
		     value="1" title="同时发送短信提醒" lay-filter="isSendMsg">
		</div>
	</div> -->
