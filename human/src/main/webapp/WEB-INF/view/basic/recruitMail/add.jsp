		...
		<div class="alertFrom">
			<form class="layui-form" id="addForm" action="" method="post">
				...
				<div class="layui-form-item accept" style="display:none;">
					...
					<div class="layui-input-inline">
						<input type="text" name="exchangeMailServerHost" id="exchangeMailServerHost"   placeholder="例如:mailbj.xdf.cn" autocomplete="off" class="layui-input">
					</div>
					<div class="layui-form-mid layui-word-aux"><font color="red">*</font></div>
				</div>
				...
				<div class="layui-form-item send" style="display:none;">
					...
					<div class="layui-input-inline">
						<input type="text" name="sendMailServerHost" id="sendMailServerHost"   placeholder="例如:mailbj.xdf.cn" autocomplete="off" class="layui-input">
					</div>
					<div class="layui-form-mid layui-word-aux"><font color="red">*</font></div>
				</div>
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-inline">
					<input type="text" id="domain"  name="domain"  lay-verify="required" placeholder="请输入域名" autocomplete="off" class="layui-input">					
					</div>
					<div class="layui-form-mid layui-word-aux"><font color="red">*</font></div>
				</div>
...
<script type="text/javascript" src="<%=basePath %>/static/basic/js/recruitMail/add.js"></script>
</html>