	 ...
	 <form class="layui-form" >
	  <div class="layui-form-item collapse in" id="collapseOne">
		<div class="layui-form-item">
			    <div class="layui-inline">
					...
					<div class="layui-input-inline" >					
						<select name="website" id="website" lay-filter="website">
				...
				<div class="layui-inline">
					...
					<div class="layui-input-inline" >					
						<select name="modularId" id="modularId">
							<option value="">请选择</option>							    					
	    				</select>
					</div>
				</div>
		...
		<div class="y-role">
            ...
            <!--/工具栏-->
            <!--文字列表-->
            <table class="tableList"  id="resumeKeywordTable">
            </table>
        </div>
    </div>   
</body>
<script type="text/javascript" src="<%=basePath %>/static/basic/js/resumeKeyword/list.js"></script>
</html>