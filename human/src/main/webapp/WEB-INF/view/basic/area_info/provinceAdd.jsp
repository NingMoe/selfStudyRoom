...
<head>
	...
	<body>
		<div class="alertFrom">
			...
			<input type="hidden" name="areaLevel" value="1">																		
				<div class="layui-form-item">
					<label class="layui-form-label" style="width: 150px;">省份名称</label>
					<div class="layui-input-inline">
						<input type="text" name="areaName" id="areaName" lay-verify="required" placeholder="请输入省份名称" autocomplete="off" class="layui-input">
					</div>
