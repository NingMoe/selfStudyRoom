	...
	<div class="alertFrom">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input name="name" id="name" style="width: 180px;" type="text"
						placeholder="请输入部门名称" class="layui-input" lay-verify="required">
				</div>
			</div>

			<div class="layui-form-item">
				<label class="layui-form-label" style="width: 84px;">banner图:</label>
		...
		<script type="text/javascript">
	    	layui.use(['form', 'layedit','upload'], function(){
	    	  ...
	    	  //监听提交
	    	  var s = layui.upload({
	    			url: jsBasePath+'/customer/centerDept/add.html',
	    			isAuto : false,
