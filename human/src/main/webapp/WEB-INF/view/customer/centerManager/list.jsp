...
<body >
 <div class="main-wrap">
  <fieldset class="layui-elem-field" style="padding: 15px;" id="serachFrom">
	<legend data-toggle="collapse" data-parent="serachFrom" href="#collapseOne"  style="color: #1AA094;">学员中心菜单管理&nbsp;<li class="fa fa-angle-double-down" id="ic"></li></legend>
	 <form class="layui-form" >
	  ...
	  <div class="layui-form-item" hidden="true">			
		...
		<div class="layui-form-item">	
    			...
    			<select name="modelId" id="modelId" style="width: 150px;">
...
<script type="text/javascript" src="<%=basePath %>/static/customer/js/config_menu_list.js"></script>
</html>