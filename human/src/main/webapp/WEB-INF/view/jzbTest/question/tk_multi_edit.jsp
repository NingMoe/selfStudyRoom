...
<body style="padding: 20px;">
			...
			<div class="addTimu multi">
				...
				<div class="layui-form-item layui-form-text"
					...
					<div class="layui-input-inline" style="width: 60%;">
						<textarea class="layui-textarea" lay-verify="required" name="multi_content">${ques.qContent }</textarea>
					</div>
				</div>
				<div class="layui-form-item layui-form-text"
					style="margin-top: 5px;">
					...
					<div class="layui-input-inline" style="width: 60%;">
						<textarea class="layui-textarea" lay-verify="required" name="tkAnswer">${ques.tkAnswer }</textarea>
					</div>
				</div>
			</div>
			</c:forEach>
	...
	<script type="text/javascript"
		src="<%=basePath%>/static/jzbTest/question/tk_multi_edit.js"></script>
