			...
			<form class="layui-form" id="addForm" action="" method="post" >
			 <input type="hidden" name="ruleId" id="ruleId" value="${cc.ruleId}">				
				...
				<label class="layui-form-label">组合:<font color="red">*</font></label>
					<div class="layui-input-block">
						<input type="text" name="combinationData" lay-verify="required" autocomplete="off" placeholder="请输入组合班号,多个班号以逗号隔开" class="layui-input">
					</div>
				</div>
...
<script type="text/javascript" src="<%=basePath %>/static/ContinuedClass/importCombinationData/add.js"></script>
</html>