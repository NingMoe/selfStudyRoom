...
function initreport_1(){
	...
	$.ajax({
		url : jsBasePath + "/ielts/teacherstudentinfo/selectstudentapply.html",
		type : "POST",
		dataType : "json",
		data : {
...
function initreport_2(){
	var integral_time = getintegralime();
	$.ajax({
		url : jsBasePath + "/ielts/teacherstudentinfo/selectstudentrecovery.html",
		type : "POST",
		dataType : "json",
		data : {
...
function initreport_3(){
	var integral_time = getintegralime();
	$.ajax({
		url : jsBasePath + "/ielts/teacherstudentinfo/selectstudentaverage.html",
		type : "POST",
		dataType : "json",
		data : {
			left_test_time : integral_time.left_integral_time,
		           ...
		           series : [
		                     {
		                         ...
		                         type:'bar',
		                         barWidth: '60%',
		                         data:[data.listenavg.toFixed(2), data.readavg.toFixed(2), data.readavg.toFixed(2), data.talkavg.toFixed(2), data.totalcount.toFixed(2)]
		                     }
		           ]
				});
			}else{
...
function initreport_4(){
	var integral_time = getintegralime();
	$.ajax({
		url : jsBasePath + "/ielts/teacherstudentinfo/selectstudentmaxtotal.html",
		type : "POST",
		dataType : "json",
		data : {
			left_test_time : integral_time.left_integral_time,
...
function initreport_5(){
	var integral_time = getintegralime();
	$.ajax({
		url : jsBasePath + "/ielts/teacherstudentinfo/selectclasstypecount.html",
		type : "POST",
		dataType : "json",
		data : {
			left_test_time : integral_time.left_integral_time,
...
function initreport_6(){
	var integral_time = getintegralime();
	$.ajax({
		url : jsBasePath + "/ielts/teacherstudentinfo/selectachievesource.html",
		type : "POST",
		dataType : "json",
		data : {
			left_test_time : integral_time.left_integral_time,
...
function initreport_7(){
	var integral_time = getintegralime();
	$.ajax({
		url : jsBasePath + "/ielts/teacherstudentinfo/selectgradeaverage.html",
		type : "POST",
		dataType : "json",
		data : {
			left_test_time : integral_time.left_integral_time,
