...
<body >
			...
			<div class="layui-inline">
				<label class="layui-form-label" style="white-space: nowrap;">快速新增:</label>
					<div class="layui-input-inline" >
							<input class="layui-input"  lay-verify="email|isSupser"  name="emailAddr" placeholder="输入汇报关系人邮箱地址" id="emailAddr">
					</div>
					</div>
			<div class="layui-inline">
				<button type="button"
    ...
    <script type="text/javascript" src="<%=basePath %>/static/basic/js/employee/emp_cfig_super.js"></script>
    <script type="text/javascript">
    	function initTable() {
    		//初始化Table 不 
    		$("#tableList").bootstrapTable({
    			url : jsBasePath + '/basic/employee/querySupserList.html', //请求后台的URL（*）
    			//method: 'get',      //请求方式（*）
    			method : 'post',
    			...
    			uniqueId : "superId", //每一行的唯一标识，一般为主键列
    			...
    			columns : [{
    				...
    				formatter : function(value, row, index) {
    					var op = "";
    					op += "<button  class='layui-btn layui-btn-mini layui-btn-danger' onclick='return delSuper(\"" + row.superId + "\");'><i class='fa fa-times'></i>&nbsp;删除</button >&nbsp;";
    					return op;
    				}
    			}],
