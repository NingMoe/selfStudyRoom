...
<head>
	...
	<body>
		...
		<div class="layui-tab layui-tab-card row" lay-filter="tabChange">
				...
				<input type="hidden" id="sendTel20170428"  value="${sr.sendTel}"/>
				<input type="hidden" id="seekerId20170428"  value="${sr.seekerId}"/>
				<input type="hidden" id="resumeId20170428"  value="${sr.resumeId}"/>
				...
				<label class="layui-form-label"></label>
					<div class="layui-input-block" >
						<button class="layui-btn"  onclick="sendMsg20170428();">立即发送</button>
