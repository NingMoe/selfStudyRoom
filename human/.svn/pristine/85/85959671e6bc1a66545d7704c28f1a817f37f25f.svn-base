...
<body ontouchstart>
	<div class="weui-cells_form" style="margin-bottom:60px;">
	    <input id="rpeId" type="hidden" name="rpeId" value="${rpe.id }">
		...
		<div class="weui-cell">
			...
			<input class="weui-input"  style="text-align:left;" id="projectName"  name="projectName"  placeholder="请输入项目名称" type="text"  value="${rpe.projectName }">
		   </div>
		</div>
		...
		<div class="weui-cell">
			...
			<div class="weui-cell__bd">
			 <textarea class="weui-textarea" style="text-align:left;" placeholder="请输入项目职责" rows="5" name="responsibilityDescribe" id="responsibilityDescribe">${rpe.responsibilityDescribe }</textarea>
		    </div>
		</div>
		...
		<div class="weui-cell">
			...
			<div class="weui-cell__bd">
			<input class="weui-input"  style="text-align:left;" id="companyName"  name="companyName"  placeholder="请输入公司名称" type="text"  value="${rpe.companyName }">
		   </div>
		</div>
	   ...
	   <div class="weui-cell">
		...
		<div class="weui-cell">
			...
			<div class="weui-cell__bd">
			 <textarea class="weui-textarea" style="text-align:left;" placeholder="请输入项目描述" rows="5" name="projectDescribe" id="projectDescribe">${rpe.projectDescribe }</textarea>
		    </div>
		</div>
...
<script type="text/javascript" src="<%=basePath%>/static/front/js/resume/editProjectExperience.js"></script>
</html>