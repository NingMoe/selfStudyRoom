...
/*        AccessToken token = WeixinUtil.getAccessToken(appId, appSecret);
        ...
        m.put("Remark", remark);
        temp.setData(m);
        String jsonString = JSONArray.fromObject(temp).toString();
    ...
    public static void main(String[] args) {
    	WxTemplate temp = new WxTemplate();
    	temp.setUrl("123");
    	System.out.println(JSONArray.fromObject(temp).toString());
	}
}
