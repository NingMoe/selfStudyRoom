...
<body>
	...
	layui.use([ 'element', 'form' ], function() {
		...
		$.post(jsBasePath + '/wechat/binding/feedback/closeFeedBack.html', {id:$("#baseId").val(),score: $("#score").val(),closeDesc:$("#closeDesc").val(),closeType:$("#closeType").val()}, function(data, status) {
			layer.close(index);
			if(data.flag){
