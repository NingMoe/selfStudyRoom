...
function(a) {
    ...
    a.fn.editableutils = {
        ...
        getConfigData: function(b) {
            ...
            function(a, b) { ("object" != typeof b || b && "object" == typeof b && (b.constructor === Object || b.constructor === Array)) && (c[a] = b)
            }),
            c
        },
...
function(a) {
    ...
    a.extend(b.prototype, {
        ...
        value2html: function(b, c, d, e) {
            ...
            return null === b ? g.call(this) : this.onSourceReady(g,
            function() {
                f.resolve()
            }),
            f.promise()
            ...
            if ("string" == typeof d) {
                ...
                var h = a.extend({
                    ...
                    success: a.proxy(function(d) {
                        ...
                        a.isArray(this.sourceData) ? (f && (f.sourceData = this.sourceData, a.each(f.callbacks,
                        function() {
                            this.call()
                        })), this.doPrepend(), b.call(this)) : (c.call(this), f && a.each(f.err_callbacks,
                        function() {
                            this.call()
                        }))
                    },
                    ...
                    error: a.proxy(function() {
                        c.call(this),
                        f && (f.loading = !1, a.each(f.err_callbacks,
                        function() {
                            this.call()
                        }))
                    },
...
function(a) {
    ...
    a.extend(b.prototype, {
        renderList: function() {
            ...
            c = function(d, e) {
                var f;
                if (a.isArray(e)) for (var g = 0; g < e.length; g++) if (f = {},
                e[g].children) f.label = e[g].text,
                d.append(c(a("<optgroup>", f), e[g].children));
                else {
                    f.value = e[g].value,
...
function(a) {
    ...
    a.extend(b.prototype, {
        renderList: function() {
            ...
            if (this.$tpl.empty(), a.isArray(this.sourceData)) {
                for (var c = 0; c < this.sourceData.length; c++) {
                    ...
                    var d = a("<span>");
                    d[this.options.escape ? "text": "html"](" " + this.sourceData[c].text),
                    b.append(d),
        ...
        str2value: function(b) {
            var c, d = null;
            return "string" == typeof b && b.length ? (c = new RegExp("\\s*" + a.trim(this.options.separator) + "\\s*"), d = b.split(c)) : d = a.isArray(b) ? b: [b],
            d
        },
...
function(a) {
    var b = function(b, c) {
        ...
        a.fn.combodate.defaults, c, this.$element.data()), void this.init()) : void a.error("Combodate should be applied to INPUT element")
    };
    b.prototype = {
        constructor: b,
        init: function() {
        ...
        getValue: function(b) {
            ...
            function(a, b) {
                if ("ampm" !== a) {
                    var c = "day" === a ? 1 : 0;
                    return d[a] = e["$" + a] ? parseInt(e["$" + a].val(), 10) : c,
        ...
        setValue: function(b) {
            ...
            if (b) {
                ...
                function(a, b) {
                    "ampm" !== a && (f[a] = d[b[1]]())
                }), this.$ampm && (f.hour >= 12 ? (f.ampm = "pm", f.hour > 12 && (f.hour -= 12)) : (f.ampm = "am", 0 === f.hour && (f.hour = 12))), a.each(f,
                function(a, b) {
...
function(a) {
    ...
    function c(b, c) {
        ...
        for (var h in e) c.test(h) && (d = h.replace(g,
        function(a, b) {
    ...
    e.prototype = {
        ...
        fillMonths: function() {
            for (var a = "",
            b = 0; 12 > b;) a += '<span class="month">' + k[this.o.language].monthsShort[b++] + "</span>";
