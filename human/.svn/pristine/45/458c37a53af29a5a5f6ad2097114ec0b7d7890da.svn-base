...
function  classImport(index){
	...
	var url=jsBasePath+"/continued_class/importCombinationData/uploadLoadClassExcel.html?ruleId="+ruleId;
	// 表单的提交
	$('#addForm').form({
		url:url ,
...
function downLoadExcel(){
   var url=jsBasePath+"/continued_class/importCombinationData/downLoadClassExcel.html";
