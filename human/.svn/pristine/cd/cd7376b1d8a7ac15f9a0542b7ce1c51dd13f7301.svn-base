...
function delImg(ob){
	...
	function closeFeedback(baseId) {
		layer.open({
			  ...
			  type: 2,
			  area: ['90%', '60%'], //宽高
			  content:  jsBasePath+'/wechat/binding/feedback/closeFeedBackView.html?id='+baseId+'&closeType=1'
			});
	}
	...
	function fdfeedback(){
		...
		for(var j=0;j<imgs.length;j++){
	      ...
	      xhr.open('post', jsBasePath+'/wechat/binding/feedback/fbFeedBack.html');
