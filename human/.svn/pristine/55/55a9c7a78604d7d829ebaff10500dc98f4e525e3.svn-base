...
<body >
	...
	<fieldset class="layui-elem-field" style="padding: 15px;" id="serachFrom">
		...
		<div class="layui-form-item collapse in" id="collapseOne">
			...
			<button onClick="basicModule.refreshTable('areaTable');" type="button" class="layui-btn"><li class="fa fa-search"></li>&nbsp;搜索</button>
		</div>
  		</fieldset>
  		</form>
  		<div class="y-role">
            ...
            <!--/工具栏-->
            <!--文字列表-->
            <table class="tableList"  id="areaTable">
            </table>
            <div id="toolbar">
            	<button onClick="basicModule.areaMo.toAdd('2');" type="button"
...
<script type="text/javascript" src="<%=basePath %>/static/basic/js/areaInfo/cityList.js"></script>
</script>  
</html>
