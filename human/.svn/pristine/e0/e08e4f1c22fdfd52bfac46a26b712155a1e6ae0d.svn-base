	 ...
	 <form class="layui-form" >
	  <div class="layui-form-item collapse in" id="collapseOne">		
		<div class="layui-form-item">				
				...
				<label class="layui-form-label" style="width:10%;">规则部门</label>
				<div class="layui-input-inline" style="width:10%;">
...
<script type="text/javascript" src="<%=basePath %>/static/ContinuedClass/ContinuedClassRule/list.js"></script>
