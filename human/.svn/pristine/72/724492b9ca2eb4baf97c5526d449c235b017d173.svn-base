    ...
    <script type="text/javascript">
    	function initTable() {
    		...
    		$("#tableList").bootstrapTable({
    			url : jsBasePath + '/recruit/InterAppr/query.html', //请求后台的URL（*）
    			method : 'post',
    			...
    			columns : [
    			   {
    				...
    				formatter : function(value, row, index) {
    					var op = "";
    					op += "<button  class='layui-btn layui-btn-mini layui-btn-normal' onclick='return jdDesc(\"" + row.resumeId + "\",\"" + row.flowCode + "\");'><i class='fa fa-pencil'></i>&nbsp;反馈</button >";
    					return op;
    				}
    			}],
