...
<title>新东方滨湖保利拉菲校区12月24日盛大开业，预售课程优惠券充200抵500！</title>
<meta charset="UTF-8">
...
<div class="xiaoqu">
<!-- 	<p class="xiaoqu_p">校区展示</p> -->
<!-- 	<div class="lunbo"> -->
<!-- 		 	<div class="slider" > -->
<!-- 			  	<ul class="lunbo_ul" style="position: absolute; left: 0px; "> -->
<%-- 				    <li ><a href="#" target="_blank"><img src="<%=basePath%>/static/activity/frontWeixin/img/lunbo1.jpg" alt="校区图片" style="width: 100%; height: 100%;"></a></li> --%>
<%-- 					<li ><a href="#" target="_blank"><img src="<%=basePath%>/static/activity/frontWeixin/img/lunbo1.jpg" alt="校区图片" style="width: 100%; height: 100%;"></a></li> --%>
<%-- 					<li ><a href="#" target="_blank"><img src="<%=basePath%>/static/activity/frontWeixin/img/lunbo1.jpg" alt="校区图片" style="width: 100%; height: 100%;"></a></li> --%>
<%-- 					<li ><a href="#" target="_blank"><img src="<%=basePath%>/static/activity/frontWeixin/img/lunbo1.jpg" alt="校区图片" style="width: 100%; height: 100%;"></a></li> --%>
<!-- 			  	</ul> -->
<!-- 				<div class="focus" style="min-height: 20px; position: absolute; bottom: 0px; background: rgba(0, 0, 0, 0.5); width: width:94.7%; height: 48px; z-index: 2;"> -->
<!-- 					<div style="width: 100px; position: absolute; right: 40%; top: 50%; margin-top: -5px;"> -->
<!-- 						<span class="current" style="display: block; float: left; cursor: pointer;"></span> -->
<!-- 						<span class="" style="display: block; float: left; cursor: pointer;"></span> -->
<!-- 						<span class="" style="display: block; float: left; cursor: pointer;"></span> -->
<!-- 						<span class="" style="display: block; float: left; cursor: pointer;"></span> -->
<!-- 					</div> -->
<!-- 				</div> -->
...
<%-- <script type="text/javascript" src="<%=basePath%>/static/activity/frontWeixin/js/slider.js"></script> --%>
<script type="text/javascript" src="<%=basePath%>/static/activity/frontWeixin/js/index.js"></script>
</html>