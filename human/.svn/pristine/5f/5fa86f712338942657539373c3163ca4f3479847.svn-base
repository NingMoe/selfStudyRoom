				...
				<form class="layui-form" id="editForm" >
								...
								<div class="row">
									<div class="layui-inline">
										...
										<div class="layui-input-inline">
											<input type="text" name="createTime"   value="<fmt:formatDate value='${cm.createTime}' pattern='yyyy-MM-dd HH:mm:ss'/>" <c:if test="${cm.acctype=='校长信箱'}">readonly</c:if>  <c:if test="${cm.openId==null}">onclick="layui.laydate({elem: this,istime: true, format: 'YYYY-MM-DD hh:mm:ss'})"</c:if> class="layui-input"  lay-verify="required" autocomplete="off" >
										</div>
									</div>
									<div class="layui-inline">
										...
										<div class="layui-form layui-input-inline">
											...
											<select name="acctype" lay-verify="required"  <c:if test="${cm.acctype=='校长信箱'}">disabled</c:if>>
									...
									<div class="layui-inline">
										...
										<div class="layui-input-inline">
											<input type="text" name="name" value="${cm.name}" class="layui-input" autocomplete="off">
										</div>
									</div>
									<div class="layui-inline">
										<label class="layui-form-label">联系方式:</label>
										<div class="layui-input-inline">
											<input type="text" name="telPhone" value="${cm.telPhone}" class="layui-input" autocomplete="off" lay-verify="phone">
										</div>
									</div>
									<c:if test="${cm.acctype=='校长信箱'}">
									<div class="layui-inline">
						...
						<div class=" titleDiv" >
							...
							<div class="layui-form-item">
										...
										<div class="layui-input-block">
											<input type="text" name="title" value="${cm.title}"  <c:if test="${cm.acctype=='校长信箱'}">readonly</c:if> class="layui-input" autocomplete="off"  placeholder="请输入反馈主题"  lay-verify="required">
										</div>
									</div>
							<div class="layui-form-item" >
						...
						<div class="row "  style="border-bottom: 1px solid #1AA094;margin-top: 5px;padding-bottom: 5px;">
							...
							<div class="layui-form-item">
								...
								<div class="layui-inline">
										...
										<div class="layui-input-inline"  style="width:500px;">
											<input type="text" name="cmd.demandDesc" value="${d.demandDesc}" class="layui-input" autocomplete="off">
										</div>
									</div>
							...
							<div class="layui-form-item">
										...
										<c:if test="${cm.state==0}"><button class="layui-btn" lay-submit="" optype="1"> 信息完善</button>&nbsp;&nbsp;</c:if>
...
function add(){
    	  layer.prompt({title: '输入需要跟进人员帐号，并确认', formType: 3}, function(text, index){
        	  ...
        	  $.post(jsBasePath+"/customer/mailFox/addConfig.html",{userName:$.trim(text)},function(data,status){
  				layer.close(index); 
  				if(data.flag==false){
  					layer.alert(data.msg,{icon:2});
  				}else{
  					$("#tracer").val(data.obj.loginName);
