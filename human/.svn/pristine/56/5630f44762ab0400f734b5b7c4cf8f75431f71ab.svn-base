...
@Controller
@RequestMapping("/recruit/insideRecommend/")
public class MyInsideRecommendController {
    
    private final  Logger logger = LogManager.getLogger(MyInsideRecommendController.class);
    ...
    @Resource
    private MyInsideRecommendService ioService;
    ...
    public ModelAndView toList(){
        ModelAndView mav=new ModelAndView("/recruitment/insideRecommend/list");
        //获取当前登录人能看到的机构
