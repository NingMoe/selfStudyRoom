...
<body>
	<div class="main-wrap">
		...
		<div class="ui-center">
			...
			<div class="ui-top-t">
				</span> <span class="ui-font">学&nbsp;员&nbsp;号&nbsp;：</span> <span> <input
					class="ui-input" type="text" value="${code}">
				</span>
			</div>
		</div>
		<div class="yubei">
			<div class="ui-start font-s " style="margin-top: 8%;">预备班</div>
			<div class="ui-time font-s time-font time-font">${cc.preStarttime }&nbsp;至
				&nbsp;${cc.preEndtime }</div>
		...
		<div class="ui-tab-page yubei">
			<div class="ui-start bottom title-font" style="font-weight: 800;">随堂测试成绩</div>
			<div style="width: 100%; height: 300px; margin: 1% 2%;" id="report">

			</div>
			<div class="ui-start bottom  report_1 title-font"
				style="font-weight: 800;">高中单词测试成绩</div>
			<div style="width: 100%; height: 300px; margin: 1% 2%;" id="report_1">

			</div>
			<div class="ui-title ui-stage report_JHPre title-font">阶段测试</div>
			<div style="width: 100%; height: 300px; margin: 1% 5%;"
				id="report_JHPre"></div>
			<img style="height: 311px; width: 100%" alt=""
				src="<%=basePath%>/static/northamerica/examineelist/image/picture.png">
		</div>
		<!-- 		page3 -->
		<div class="ui-tab-page yubei">
			<form style="margin: 5%">
				<fieldset style="border: 1px solid red">
					<legend
						style="font-size: 48px; color: red !important; background: white !important">结课评语:</legend>
		...
		<div class=" ui-tab-page  jichu">
			...
			<div class="ui-time  font-s time-font">${cc.basStarttime }&nbsp;至&nbsp;${cc.basEndtime}
			</div>
			...
			<div class="ui-start bottom report_Js title-font"
				style="font-weight: 800;">随堂测试成绩</div>
			<div style="width: 100%; height: 300px; margin: 1% 5%;"
				id="report_Js"></div>
		</div>
		<!-- 		page5	 -->
		<div class="ui-tab-page jichu">
			...
			<div style="width: 100%; height: 300px; margin: 1% 5%;"
				id="report_Jc"></div>
			<div class="ui-title ui-stage report_JHBas title-font">阶段测试</div>
			<div style="width: 100%; height: 300px; margin: 1% 5%;"
				id="report_JHBas"></div>
		...
		<div class="ui-tab-page qianghua">
			...
			<div class="ui-time font-s time-font">${cc.strStarttime }&nbsp;至&nbsp;${cc.strEndtime }</div>
		...
		<div class="ui-tab-page chongci">
			<div class="ui-start title-font time-font">冲刺班</div>
			...
			<div class="ui-tab-page2 report_JHC stageCeshi">
				...
				<div style="width: 100%; height: 400px; margin: 1% 5%;"
					id="report_MK" class="report_MK_0"></div>
			</div>
			<div class="ui-tab-page2 page_SK toffleSk">
				...
				<div style="width: 100%; height: 400px; margin: 1% 5%;"
					id="report_SK"></div>
				<div
					style="width: 100%; height: 300px; padding: 1%; margin: 3% 5%; float: left"
					id="report_SK_r"></div>
				<div
					style="width: 100%; height: 300px; padding: 1%; margin: 3% 5%; float: left;"
					id="report_SK_l"></div>
			...
			<div style="width: 100%; height: 300px; margin: 1% 2%;"
				id="report_MK_Z" class='toffleGrade'></div>
		</div>
