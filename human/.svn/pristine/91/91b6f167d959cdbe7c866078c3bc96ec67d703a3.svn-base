...
public class RoleController {
	...
	public ModelAndView index() {
		ModelAndView mav = new ModelAndView("/manager/role/list");
		return mav;
	}
	...
	public PageView query(Role role,PageView pageView){
	    role.setCreateUser(Common.getMyUser().getUserid());
    ...
    public ModelAndView getById(Role role) {
        ...
        mav.setViewName("/manager/role/edit");
        return mav;
    }
    ...
    public ModelAndView toCfgRoleRes(Role role) {
        ModelAndView mav = new ModelAndView("/manager/role/cfgRoleRes");
