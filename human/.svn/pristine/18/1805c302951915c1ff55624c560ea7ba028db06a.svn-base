...
<head>
	...
	<script type="text/javascript" src="<%=basePath %>/static/ielts/student/studentinfoadd.js"></script>
</head>
			...
			<div class="layui-form">
				<div class="layui-form-item">
					<div class="layui-inline" style="margin: 0 auto 10px auto">
						...
						<div class="layui-input-inline">
							<input name="add_student_name" id="add_student_name" lay-verify="not_null" style="width: 160px;" type="text" placeholder="请输入学生姓名" class="layui-input">
						</div>
					</div>
					<div class="layui-inline" style="margin: 0 auto 10px auto">
						<label class="layui-form-label" style="width: 100px;">手机号:<span style="color: red">*</span></label>
						<div class="layui-input-inline">
							<input name="add_student_phone" id="add_student_phone" lay-verify="not_null" style="width: 160px;" type="text" placeholder="请输入手机号" class="layui-input">
						</div>
					</div>
				</div>
				...
				<div class="layui-form-item">
					<div class="layui-inline" style="margin: 0 auto 10px auto">
						...
						<div class="layui-input-inline">
							<input name="add_school" id="add_school" style="width: 160px;" type="text" placeholder="请输入学校" class="layui-input">
						</div>
					</div>
					<div class="layui-inline" style="margin: 0 auto 10px auto">
						<label class="layui-form-label" style="width: 100px;">年级:</label>
						<div class="layui-input-inline">
							<input name="add_grade" id="add_grade" style="width: 160px;" type="text" placeholder="请输入年级" class="layui-input">
						</div>
					</div>
				</div>
				...
				<div class="layui-form-item">
					<div class="layui-inline" style="margin: 0 auto 10px auto">
						...
						<div class="layui-input-inline">
							<input name="add_advisor" id="add_advisor" lay-verify="not_null" style="width: 160px;" type="text" placeholder="请输入指导教师" class="layui-input">
						</div>
					</div>
					<div class="layui-inline" style="margin: 0 auto 10px auto">
						<label class="layui-form-label"  style="width: 100px;">学管:<span style="color: red"></span></label>
						<div class="layui-input-inline">
							<input name="add_student_manager" id="add_student_manager" lay-verify="not_null" style="width: 160px;" type="text" placeholder="请输入学管" class="layui-input">
						</div>
					</div>
				</div>
				...
				<div class="layui-form-item">
					<div class="layui-inline" style="margin: 0 auto 10px auto">
						...
						<div class="layui-input-inline">
							<input name="add_teachermails" id="add_teachermails" lay-verify="not_null" style="width: 350px;" type="text" placeholder="请输入代课教师" class="layui-input">
				...
				<div class="layui-form-item">
					<div class="layui-input-block" >
						<button id="student_info_add" class="layui-btn">立即提交</button>
					</div>
				</div>
			</div>
		</div>
