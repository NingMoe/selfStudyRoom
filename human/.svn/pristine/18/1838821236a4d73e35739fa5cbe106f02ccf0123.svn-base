			...
			<form class="layui-form" id="addForm" action="" method="post" >
			   <div class="layui-form-item">
				...
				<label class="layui-form-label">关键词:<font color="red">*</font></label>
					<div class="layui-input-block">
						<input type="text" name="name" lay-verify="required" autocomplete="off" placeholder="请输入关键词" class="layui-input">
					</div>
				</div>
...
<script type="text/javascript" src="<%=basePath %>/static/basic/js/resumeKeyword/add.js"></script>
</html>