		...
		<div id="quesDiv1">
			...
			<div class="layui-form-item" style="margin-top: 20px;margin-bottom: 10px;">
				...
				<div class="layui-input-inline" style="width:15%;margin-right: 0px">
					<input type="text" id="contentTime" name="contentTime" class="layui-input" value="${questionType.mrContentTime}" lay-verify="required" style="width: 100%"> 
				</div>
				</c:if>
			</div>
			...
			<div class="layui-form-item" style="margin-bottom: 10px;">
				...
				<div class="layui-input-inline" style="width:15%;margin-right: 0px">
					<input type="text" id="answerTime" name="answerTime" value="${questionType.mrAnswerTime}" lay-verify="required" class="layui-input" style="width: 100%">  
				</div>
				</c:if>
			</div>
			<c:if test="${questionType.isNeedParse eq '1' }">
