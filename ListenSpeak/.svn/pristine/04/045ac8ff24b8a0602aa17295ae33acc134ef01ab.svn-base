		...
		<div id="quesDiv1">
			<c:if test="${!empty question.zdmessage}">
				...
				<div class="layui-form-item layui-form-text" style="margin-bottom: 10px;">
					<div class="layui-input-inline" style="width:72%;margin-left: 12%;margin-right: 0px">
						<textarea name="zdmessage" id="zdmessage" class="layui-textarea" lay-verify="required">${question.zdmessage }</textarea>
					</div>
				</div>
			</c:if>
			...
			<div class="layui-form-item" style="margin-top: 20px;margin-bottom: 10px;">
				...
				<div class="layui-input-inline" style="width:22%;margin-right: 0px">
					<input type="text" id="contentTime" name="contentTime" class="layui-input" value="${question.contentTime }" lay-verify="required" style="width: 100%"> 
				</div>
				</c:if>
			</div>
			...
			<div class="layui-form-item layui-form-text" style="margin-bottom: 10px;">
				<div class="layui-input-inline" style="width:72%;margin-left: 12%;margin-right: 0px">
					<textarea name="content" id="content" class="layui-textarea" lay-verify="required">${question.content }</textarea>
				</div>
			</div>
			...
			<div class="layui-form-item" style="margin-bottom: 10px;">
				...
				<div class="layui-input-inline" style="width:15%;margin-right: 0px">
					<input type="text" id="answerTime" name="answerTime" lay-verify="required" class="layui-input" value="${question.answerTime }" style="width: 100%">  
				</div>
				</c:if>
			</div>
			<c:if test="${!empty question.parseText}">
			<div class="layui-form-item layui-form-text" style="margin-bottom: 10px;">
				<div class="layui-input-inline" style="width:72%;margin-left: 12%;margin-right: 0px">
					<textarea name="parseText" id="parseText" lay-verify="required" class="layui-textarea" >${question.parseText }</textarea>
				</div>
			</div>
			</c:if>
...
<script type="text/javascript" src="<%=basePath%>/static/question/simple_edit.js"></script>
