			...
			<form class="layui-form" id="addForm" action="" method="post">
			 ...
			 <input type="hidden" name="areaLevel" value="${area.areaLevel }">																
				<div class="layui-form-item">
					<label class="layui-form-label" style="width: 150px;">城市名称</label>
					<div class="layui-input-inline">
						<input type="text" name="areaName" id="areaName" lay-verify="required" placeholder="请输入城市名称" autocomplete="off" class="layui-input" value="${area.areaName }">
					</div>
