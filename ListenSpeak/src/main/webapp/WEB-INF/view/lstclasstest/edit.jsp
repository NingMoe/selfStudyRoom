	...
	<div class="alertFrom">
		<form class="layui-form" id="addForm" action="" method="post">
			<div class="layui-form-item">
				<input  id="id" type="hidden" name="id"  lay-verify="required" placeholder="请输入考试名称" 
						 class="layui-input" value="${lct.id}">
				<label class="layui-form-label" style="width:20%">考试名称:<font color="red">*</font></label>
				<div class="layui-input-inline" style="width:60%">
					<input type="text" id="name" name="name"  lay-verify="required" placeholder="请输入考试时间" 
						 class="layui-input" value="${lct.name}">
				</div>
			</div>
<!-- 			<div class="layui-form-item"> -->
...
<%-- 						 class="layui-input" value="${lct.continueTime}"> --%>
<!-- 				</div> -->
<!-- 			</div> -->
			<div class="layui-form-item" >
				...
				<div class="layui-input-inline" style="width:60%">
					<input class="layui-input" placeholder="请输入结束时间" id="endTime"  lay-verify="required"
						readonly="readonly" name="endTime" value="${endTime}">
				</div>
			</div>
			<div class="layui-form-item" >
				...
				<div class="layui-input-block" id="class" name="class">
					<c:forEach items="${lst}" var="ls">
      					<input type="checkbox" name="${ls.classCode}" title="${ls.className}" <c:if test="${ls.cClassCode  eq ls.classCode }">checked</c:if>>
      				</c:forEach>
   				 </div>
			</div>
			<div class="layui-form-item">
...
<script type="text/javascript"
	src="<%=basePath%>/static/lstclasstest/edit.js"></script>
</html>