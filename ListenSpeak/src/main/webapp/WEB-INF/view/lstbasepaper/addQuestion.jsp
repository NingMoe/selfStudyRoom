		...
		<div class="layui-colla-item">
			...
			<div class="layui-colla-content layui-show">
			  	<div style="width: 90%;margin: 0px auto;">
			  		<table class="layui-table" id="ccrTable2" lay-filter="yxQuestion"></table>
			  	</div>
		  	</div>
		</div>
	</div>
...
<script type="text/html" id="paperquestionbar">
 <a class="layui-btn layui-btn-primary layui-btn-xs" lay-event="detail">查看</a> 
 <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="deleteTest">删除题目</a>
</script>
<script type="text/javascript" src="<%=basePath %>/static/lstbasepaper/questionList.js"></script>
</html>