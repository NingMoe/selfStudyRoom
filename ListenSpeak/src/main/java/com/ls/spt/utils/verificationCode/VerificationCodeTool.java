package com.ls.spt.utils.verificationCode;
...
//  private static final String [] CNUMBERS = "零,一,二,三,四,五,六,七,八,九,十".split(",");
     ...
     * */
    public BufferedImage drawVerificationCodeImage(HttpServletRequest request){
        //image
...
//      g.setColor(getRandomColor(200,250));
        ...
        request.getSession().setAttribute("validCode", randomString);
        LOG.info("验证码结果 : "+xyresult);
        request.getSession().setAttribute("validResult", String.valueOf(xyresult));
