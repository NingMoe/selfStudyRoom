...
public class KindEditorController {
    ...
    private final  Logger logger = LogManager.getLogger(KindEditorController.class);
        ...
        try {
            ...
            if (resolver.isMultipart(request)) {
                ...
                while (iter.hasNext()) {
                    ...
                    String newFileName = lsAudio+System.currentTimeMillis() + originalName.substring(originalName.lastIndexOf("."));
